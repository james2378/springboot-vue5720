...
/**
 *购票取消：(TicketCancellation)表实体类
 *
 */
@Setter
@Getter
@Entity(name = "TicketCancellation")
public class TicketCancellation implements Serializable {

    //TicketCancellation编号
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "ticket_cancellation_id")
    private Integer ticket_cancellation_id;
    // 景点名称
    @Basic
